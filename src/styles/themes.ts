...
export const themes: Theme[] = [
    ...
    // NEW SURPRISE THEMES
    {
        ...
        name: "Amethyst Void",
        background: "#0d0b14",
        backgroundGradient: "linear-gradient(180deg, #0d0b14 0%, #1a1625 100%)",
        backgroundPattern: "radial-gradient(circle at 50% 50%, rgba(157, 78, 221, 0.05) 0%, transparent 50%)",
        headerBg: "#0d0b14",
        headerBorder: "#2d2438",
        sidebarBg: "#09080e",
        ...
        accentHover: "#e6c200",
        bubble: {
            positiveColor: "#9d4edd",
            negativeColor: "#cf4545",
            positiveGlow: "rgba(157, 78, 221, 0.4)",
            negativeGlow: "rgba(207, 69, 69, 0.4)",
            fillColor: "#1a1625",
            textColor: "#f0e6ff",
            borderWidth: 2,
            glowIntensity: 0.4,
