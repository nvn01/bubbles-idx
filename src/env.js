...
export const env = createEnv({
  ...
  server: {
    ...
    CLOUDFLARE_TURNSTILE_SECRET_KEY: z.string().default("1x00000000000000000000000000000000"),
  },
   ...
   */
  client: {
    NEXT_PUBLIC_CLOUDFLARE_TURNSTILE_SITE_KEY: z.string().default("1x00000000000000000000AA"),
  },
